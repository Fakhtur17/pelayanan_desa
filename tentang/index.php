			...
			<div class="card-body">
				<div class="card-text">
					<p>
						...
						<hr>
						<blockquote>
							Web Aplikasi untuk pelayanan surat administrasi desa yang dikembangkan oleh <b><a href="#" style="text-decoration:none">kknunsoed</a></b> untuk mempermudah penduduk dalam pembuatan surat administrasi desa secara online.
							<br>
							<br>
						</blockquote>
					</p>
					...
					<hr>
					<b>©</b> e-<b>SuratDesa</b> 2026. Hak Cipta Dilindungi.
				</div>
				<br><br><br>
				<div class="row text-center">
					<div class="col-md-12">
						<img src="../assets/img/" class="img-circle"><br><br>
						<p class="text-muted">Trademark By <b><a href="#" style="text-decoration:none">kknunsoed.</a></b></p>
					</div>
...
<div class="footer bg-dark text-center">
    <span class="text-light"><strong>Copyright &copy; 2026 <a href="../" class="text-decoration-none text-white">e-SuratDesa</a>.</strong> All rights reserved.</span>
</div>
</body>
</html>