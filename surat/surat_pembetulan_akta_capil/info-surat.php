			...
			<div class="col-md-12">
				<div class="card">
					...
					<div class="container-fluid">
						<div class="row">
							<a class="col-sm-6"><h5><b>SURAT PEMBETULAN AKTA CAPIL</b></h5></a>
					...
					<form method="post" action="simpan-surat.php" enctype="multipart/form-data">
						...
						<h6 class="container-fluid" align="right"><i class="fas fa-edit"></i> Data Pembetulan Akta</h6>
						<hr width="97%">
						...
						<div class="row">
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<div class="col-sm-12">
										<input type="text" name="fno_akta" class="form-control" placeholder="Masukkan nomor akta (opsional)">
									</div>
								</div>
							</div>
							...
							<div class="col-sm-12">
								<div class="form-group">
									<label class="col-sm-12" style="font-weight: 500;">Bagian yang Dibetulkan</label>
									<div class="col-sm-12">
										<input type="text" name="fbagian_dibetulkan" class="form-control" required placeholder="Contoh: Nama / Tempat Lahir / Tanggal Lahir / Nama Ayah / Nama Ibu">
									</div>
								</div>
							</div>
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label class="col-sm-12" style="font-weight: 500;">Data Sebelum (salah)</label>
									<div class="col-sm-12">
										<input type="text" name="fdata_sebelum" class="form-control" required placeholder="Isi data yang salah">
									</div>
								</div>
							</div>
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label class="col-sm-12" style="font-weight: 500;">Data Sesudah (benar)</label>
									<div class="col-sm-12">
										<input type="text" name="fdata_sesudah" class="form-control" required placeholder="Isi data yang benar">
									</div>
								</div>
							</div>
							...
							<div class="col-sm-12">
								<div class="form-group">
									...
									<div class="col-sm-12">
										<input type="text" name="fketerangan" class="form-control" placeholder="Contoh: Untuk perbaikan data di Dispendukcapil (opsional)">
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									...
									<div class="col-sm-12">
										<input type="file" name="ffoto_kutipan_akta" class="form-control" required>
										<small class="text-muted">Disarankan JPG/PNG/PDF.</small>
									</div>
								</div>
							</div>
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<div class="col-sm-12">
										<input type="file" name="ffoto_kk_termohon" class="form-control" required>
										<small class="text-muted">Disarankan JPG/PNG/PDF.</small>
									</div>
								</div>
							</div>
						...
						<div class="container-fluid mt-3">
							<div class="alert alert-warning">
								<b>Catatan Autentik:</b> Dokumen autentik membutuhkan <b>tanda tangan langsung</b>.
								Pengambilan surat dilakukan di <b>Balai Desa</b>.
							</div>
						</div>
