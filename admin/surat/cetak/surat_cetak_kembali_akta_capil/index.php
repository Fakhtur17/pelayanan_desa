<?php 
  ...
  // ambil data penduduk + surat cetak kembali akta capil
...
<div>
  <table width="100%">
    ...
    <br>
    <div align="center"><u><h4 class="kop">SURAT CETAK KEMBALI AKTA CAPIL</h4></u></div>
  ...
  <div id="isi3">
    ...
    <table width="100%" style="text-transform: capitalize;">
      ...
      <tr>
        ...
        <td>
          <?php
            // kalau di tabel surat ada alamat_pemohon, pakai itu
            if(isset($row['alamat_pemohon']) && !empty($row['alamat_pemohon'])){
              echo $row['alamat_pemohon'];
            } else {
              // fallback: ambil dari penduduk
    ...
    <table width="100%">
      <tr>
        <td class="indentasi">
          Dengan ini mengajukan permohonan <b>cetak kembali Akta Capil</b>.
        </td>
      </tr>
    </table>
    ...
    <table width="100%" style="text-transform: capitalize;">
      <tr>
        <td class="indentasi">Keperluan / Keterangan</td>
        <td width="2%">:</td>
        <td>
          <b><u>
      ...
      <?php if(isset($row['jenis_akta']) && !empty($row['jenis_akta'])){ ?>
      <tr>
        <td class="indentasi">Jenis Akta</td>
        <td>:</td>
        <td><?php echo $row['jenis_akta']; ?></td>
      </tr>
      <?php } ?>

      <?php if(isset($row['no_akta_lama']) && !empty($row['no_akta_lama'])){ ?>
      <tr>
        <td class="indentasi">No. Akta Lama</td>
        <td>:</td>
        <td><?php echo $row['no_akta_lama']; ?></td>
      </tr>
      <?php } ?>

      <?php if(isset($row['tahun_akta']) && !empty($row['tahun_akta'])){ ?>
      <tr>
        <td class="indentasi">Tahun Akta</td>
        <td>:</td>
        <td><?php echo $row['tahun_akta']; ?></td>
      </tr>
      <?php } ?>
    </table>
