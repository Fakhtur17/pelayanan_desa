<?php
  ...
  // ambil data penduduk + data surat cetak kembali akta capil
  $qCek = mysqli_query($connect,"
    SELECT penduduk.*, surat_cetak_kembali_akta_capil.*
    FROM penduduk
    LEFT JOIN surat_cetak_kembali_akta_capil
      ON surat_cetak_kembali_akta_capil.nik = penduduk.nik
    WHERE surat_cetak_kembali_akta_capil.id_sckac = '$id'
  ");
  ...
  $baseUploadUrl = "../../../../../uploads/cetak_kembali_akta_capil/";

  // fungsi tampilan file (card + tombol lihat + unduh)
      ...
      <div class="col-md-12">
        <div class="box box-default">
          <div class="box-header with-border">
            <h2 class="box-title"><i class="fas fa-envelope"></i> Konfirmasi Surat Cetak Kembali Akta Capil</h2>
          </div>
          ...
          <div class="box-body">
            <form class="form-horizontal" method="post" action="update-konfirmasi.php">
              ...
              <!-- INFORMASI SURAT CAPIL -->
              <h5 class="box-title pull-right" style="color: #696969;">
                <i class="fas fa-info-circle"></i> <b>Informasi Surat Cetak Kembali Akta Capil</b>
              </h5>
              <br><hr style="border-bottom: 1px solid #DCDCDC;">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="box-body">
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Jenis Akta</label>
                      <div class="col-sm-9">
                        <input type="text" value="<?php echo $row['jenis_akta']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" value="<?php echo !empty($row['nomor_akta']) ? $row['nomor_akta'] : '-'; ?>" class="form-control" readonly>
                      </div>
                    </div>

                    <div class="form-group">
                      <label class="col-sm-3 control-label">Tahun Akta</label>
                      <div class="col-sm-9">
                        <input type="text" value="<?php echo !empty($row['tahun_akta']) ? $row['tahun_akta'] : '-'; ?>" class="form-control" readonly>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" value="<?php echo $row['alasan_permohonan']; ?>" class="form-control" readonly>
                      </div>
                    </div>

                    <div class="form-group">
                      <label class="col-sm-3 control-label">Asal Akta</label>
                      <div class="col-sm-9">
                        <input type="text" value="<?php echo $row['asal_akta']; ?>" class="form-control" readonly>
                      </div>
                    </div>

                    <div class="form-group">
                      <label class="col-sm-3 control-label">Daerah Penerbit</label>
                      <div class="col-sm-9">
                        <input type="text" value="<?php echo !empty($row['daerah_penerbit']) ? $row['daerah_penerbit'] : '-'; ?>" class="form-control" readonly>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="box-body">
                    <div class="form-group">
                      <label class="col-sm-2 control-label">Keterangan Alasan</label>
                      <div class="col-sm-10">
                        <input type="text" value="<?php echo !empty($row['keterangan_alasan']) ? $row['keterangan_alasan'] : '-'; ?>" class="form-control" readonly>
                      </div>
                    </div>
              ...
              <div class="row">
                <?php
                  renderFileCard("1. Foto Asli KK Termohon", $row['foto_kk'], $baseUploadUrl);
                  renderFileCard("2. Asli/Kutipan Akta (rusak/hilang/dikuasai)", $row['bukti_akta'], $baseUploadUrl);
                  renderFileCard("3. Surat Kehilangan / Surat Pernyataan Sengketa", $row['bukti_kehilangan_atau_pernyataan'], $baseUploadUrl);
                  renderFileCard("4. Surat Konfirmasi Penerbit (Luar Daerah)", $row['dokumen_konfirmasi_penerbit'], $baseUploadUrl);
                ?>
              </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="box-body">
                    <input type="hidden" name="id" value="<?php echo $row['id_sckac']; ?>">
                  </div>
                </div>
