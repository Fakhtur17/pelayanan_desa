<?php
  ...
  // ambil data penduduk + data surat domisili
  $qCek = mysqli_query($connect,"
    SELECT penduduk.*, surat_keterangan_domisili.*
    FROM penduduk
    LEFT JOIN surat_keterangan_domisili
      ON surat_keterangan_domisili.nik = penduduk.nik
  ...
  // URL folder upload (public) - DOMISILI
  $baseUploadUrl = "../../../../../uploads/persyaratan_surat_keterangan_domisili/";

  // fungsi tampilan file + tombol unduh (pakai download.php)
        ...
        <div class="box box-default">
          ...
          <div class="box-body">
            <form class="form-horizontal" method="post" action="update-konfirmasi.php">
              ...
              <!-- INFORMASI DOMISILI (sesuai kolom tabel baru) -->
              <h5 class="box-title pull-right" style="color: #696969;">
                <i class="fas fa-info-circle"></i> <b>Informasi Surat Domisili</b>
              </h5>
              <br><hr style="border-bottom: 1px solid #DCDCDC;">
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <textarea rows="3" class="form-control" style="text-transform: capitalize;" readonly><?php echo !empty($row['alamat_domisili']) ? $row['alamat_domisili'] : '-'; ?></textarea>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" value="<?php echo (!empty($row['rt_domisili']) ? $row['rt_domisili'] : '-') . ' / ' . (!empty($row['rw_domisili']) ? $row['rw_domisili'] : '-'); ?>" class="form-control" readonly>
                      </div>
                    </div>

                    <div class="form-group">
                      <label class="col-sm-4 control-label">Desa/Kel</label>
                      <div class="col-sm-8">
                        <input type="text" value="<?php echo !empty($row['desa_domisili']) ? $row['desa_domisili'] : '-'; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" value="<?php echo !empty($row['kecamatan_domisili']) ? $row['kecamatan_domisili'] : '-'; ?>" class="form-control" readonly>
                      </div>
                    </div>
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" value="<?php echo !empty($row['kabupaten_domisili']) ? $row['kabupaten_domisili'] : '-'; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" value="<?php echo !empty($row['provinsi_domisili']) ? $row['provinsi_domisili'] : '-'; ?>" class="form-control" readonly>
                      </div>
                    </div>

                    <div class="form-group">
                      <label class="col-sm-4 control-label">Lama Tinggal</label>
                      <div class="col-sm-8">
                        <input type="text" value="<?php echo !empty($row['lama_tinggal']) ? $row['lama_tinggal'] : '-'; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" value="<?php echo !empty($row['keperluan']) ? $row['keperluan'] : '-'; ?>" class="form-control" readonly>
                      </div>
                    </div>
              ...
              <div class="row">
                <?php
                  renderFileCard("KTP Pemohon", $row['ktp_pemohon'], $baseUploadUrl);
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="box-body">
                    <input type="hidden" name="id" value="<?php echo $row['id_skd']; ?>">
                  </div>
                </div>
