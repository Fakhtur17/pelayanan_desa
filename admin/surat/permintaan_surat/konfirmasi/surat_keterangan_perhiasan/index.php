<?php
  ...
  // Ambil penduduk + surat
  $qCek = mysqli_query($connect,"
    SELECT penduduk.*, surat_keterangan_perhiasan.*
    FROM penduduk
    LEFT JOIN surat_keterangan_perhiasan
      ON surat_keterangan_perhiasan.nik = penduduk.nik
  ...
  $baseUploadUrl = "../../../../../uploads/persyaratan_surat_keterangan_perhiasan/";

  // Card file + tombol lihat/unduh
        ...
        <div class="box box-default">
          ...
          <div class="box-body">
            <form class="form-horizontal" method="post" action="update-konfirmasi.php">
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <textarea rows="3" class="form-control" style="text-transform: capitalize;" readonly><?php
              ...
              <!-- INFORMASI PERHIASAN -->
              <h5 class="box-title pull-right" style="color: #696969;">
                <i class="fas fa-info-circle"></i> <b>Informasi Perhiasan</b>
              </h5>
              <br><hr style="border-bottom: 1px solid #DCDCDC;">
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" value="<?php echo $row['jenis_perhiasan']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" value="<?php echo $row['nama_perhiasan']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" value="<?php echo $row['berat']; ?> Gram" class="form-control" readonly>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" value="<?php echo $row['toko_perhiasan']; ?>" class="form-control" readonly>
                      </div>
                    </div>

                    <div class="form-group">
                      <label class="col-sm-3 control-label">Lokasi Toko</label>
                      <div class="col-sm-9">
                        <input type="text" value="<?php echo $row['lokasi_toko_perhiasan']; ?>" class="form-control" readonly>
                      </div>
                    </div>
              ...
              <div class="row">
                <?php
                  // kolom file yang kita tambahkan di tabel: ktp dan kk
                  renderFileCard("KTP Pemohon", $row['ktp'], $baseUploadUrl, "ktp");
                  renderFileCard("KK Pemohon",  $row['kk'],  $baseUploadUrl, "kk");
                ?>
              </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="box-body">
                    <input type="hidden" name="id" value="<?php echo $row['id_skp']; ?>">
                  </div>
                </div>
