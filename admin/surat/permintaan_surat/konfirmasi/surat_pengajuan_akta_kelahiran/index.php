<?php 
  ...
  // ambil data penduduk + data surat akta kelahiran
  ...
  $baseUploadUrl = "../../../../../uploads/akta_kelahiran/";
...
<style>
 ...
 .file-preview img{
  max-width: 100%;
  max-height: 260px;   /* ⬅️ ukuran diperkecil */
  object-fit: contain;
  display: block;
  margin: auto;
}
      ...
      <div class="col-md-12">
        <div class="box box-default">
          <div class="box-header with-border">
            <h2 class="box-title"><i class="fas fa-envelope"></i> Konfirmasi Surat Pengajuan Akta Kelahiran</h2>
          </div>
          ...
          <div class="box-body">
            <form class="form-horizontal" method="post" action="update-konfirmasi.php">
              ...
              <h5 class="box-title pull-right" style="color: #696969;">
                <i class="fas fa-info-circle"></i> <b>Informasi Surat Akta Kelahiran</b>
              </h5>
              <br><hr style="border-bottom: 1px solid #DCDCDC;">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" value="<?php echo $row['nama_bayi']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Jenis Kelamin Bayi</label>
                      <div class="col-sm-9">
                        <input type="text" value="<?php echo $row['jenis_kelamin_bayi']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Tempat Lahir Bayi</label>
                      <div class="col-sm-9">
                        <input type="text" value="<?php echo $row['tempat_lahir_bayi']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Tgl Lahir Bayi</label>
                      <div class="col-sm-9">
                        <input type="text" value="<?php echo tglIndo($row['tgl_lahir_bayi']); ?>" class="form-control" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Jam Lahir</label>
                      <div class="col-sm-9">
                        <input type="text" value="<?php echo !empty($row['jam_lahir_bayi']) ? $row['jam_lahir_bayi'] : '-'; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Anak Ke</label>
                      <div class="col-sm-9">
                        <input type="text" value="<?php echo !empty($row['anak_ke']) ? $row['anak_ke'] : '-'; ?>" class="form-control" readonly>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" value="<?php echo $row['nik_ayah']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Nama Ayah</label>
                      <div class="col-sm-9">
                        <input type="text" value="<?php echo $row['nama_ayah']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" value="<?php echo $row['nik_ibu']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Nama Ibu</label>
                      <div class="col-sm-9">
                        <input type="text" value="<?php echo $row['nama_ibu']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="row">
                <?php
                  renderFileCard("Surat Kelahiran RS/Puskesmas", $row['surat_kelahiran_rs'], $baseUploadUrl);
                  renderFileCard("FC Buku Nikah", $row['fc_buku_nikah'], $baseUploadUrl);
                  renderFileCard("KK Pemohon", $row['kk_pemohon'], $baseUploadUrl);
                  renderFileCard("KTP Ayah", $row['ktp_ayah'], $baseUploadUrl);
                  renderFileCard("KTP Ibu", $row['ktp_ibu'], $baseUploadUrl);
                  renderFileCard("Dokumen Pendukung Lain", $row['dokumen_pendukung_lain'], $baseUploadUrl);
                ?>
              </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <input type="hidden" name="id" value="<?php echo $row['id_spak']; ?>">
                  </div>
                </div>
