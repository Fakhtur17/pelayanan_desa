<?php
  ...
  // ambil data penduduk + surat_keterangan
  ...
  // ==============================
  // ✅ FIX UTAMA: BASE URL ABSOLUT
  // ==============================
  $PROJECT_URL = "/e-suratdesa-master"; // <-- ganti jika nama folder beda

  $baseKTPUrl = $PROJECT_URL . "/uploads/persyaratan_surat_keterangan/ktp/";
  $baseKKUrl  = $PROJECT_URL . "/uploads/persyaratan_surat_keterangan/kk/";

  // ==============================
  // ✅ fungsi tampilan file (card + lihat + unduh + preview)
  // ==============================
  function renderFileCard($label, $fileName, $baseUrl, $sub){
    ...
    if(!empty($fileName)){
      ...
      $safeFileText = htmlspecialchars($fileName, ENT_QUOTES, 'UTF-8');
      ...
      echo '        <span class="file-name">'.$safeFileText.'</span>';
      echo '      </div>';
        ...
        <div class="box box-default">
          ...
          <div class="box-body">
            <form class="form-horizontal" method="post" action="update-konfirmasi.php">
              ...
              <!-- INFORMASI SURAT -->
              <h5 class="box-title pull-right" style="color: #696969;">
                <i class="fas fa-info-circle"></i> <b>Informasi Surat Keterangan</b>
              </h5>
              <br><hr style="border-bottom: 1px solid #DCDCDC;">
              ...
              <div class="row">
                <?php
                  renderFileCard("1. KTP Pemohon", $row['ktp_pemohon'], $baseKTPUrl, 'ktp');
                  renderFileCard("2. Kartu Keluarga (KK)", $row['kk_pemohon'], $baseKKUrl, 'kk');
                ?>
              </div>
