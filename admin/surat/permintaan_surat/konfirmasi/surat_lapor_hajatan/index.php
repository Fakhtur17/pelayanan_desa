<?php
  ...
  $baseUploadUrlKtp = "../../../../../uploads/persyaratan_surat_lapor_hajatan/ktp/";
  $baseUploadUrlKk  = "../../../../../uploads/persyaratan_surat_lapor_hajatan/kk/";

  // kartu file (mirip akta kematian) + tombol download pakai download.php?sub=ktp|kk&file=...
...
<style>
  ...
  .badge-ext{
    ...
    border:1px solid #e5e7eb; background:#fff; color:#374151; font-weight:700;
  }
        ...
        <div class="box box-default">
          ...
          <div class="box-body">
            <form class="form-horizontal" method="post" action="update-konfirmasi.php">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Bukti KTP (No)</label>
                      <div class="col-sm-9">
                        <input type="text" value="<?php echo !empty($row['bukti_ktp']) ? $row['bukti_ktp'] : '-'; ?>" class="form-control" readonly>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Bukti KK (No)</label>
                      <div class="col-sm-9">
                        <input type="text" value="<?php echo !empty($row['bukti_kk']) ? $row['bukti_kk'] : '-'; ?>" class="form-control" readonly>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <!-- INFORMASI HAJATAN -->
              <h5 class="box-title pull-right" style="color:#696969;">
                <i class="fas fa-info-circle"></i> <b>Informasi Hajatan</b>
              </h5>
              <br><hr style="border-bottom:1px solid #DCDCDC;">
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" value="<?php echo $row['jenis_hajat']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" value="<?php echo tglIndo($row['tanggal']); ?>" class="form-control" readonly>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" value="<?php echo $row['pemilik']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" value="<?php echo $row['hari']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" value="<?php echo $row['jenis_hiburan']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <textarea rows="3" class="form-control" readonly><?php echo $row['alamat_pemilik']; ?></textarea>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <!-- ✅ PERSYARATAN BERKAS (KTP/KK UPLOAD) -->
              <h5 class="box-title pull-right" style="color:#696969;">
              ...
              <div class="row">
                <?php
                  // kolom upload baru: file_ktp dan file_kk
                  renderFileCard("Upload KTP", $row['file_ktp'], $baseUploadUrlKtp, "ktp");
                  renderFileCard("Upload KK",  $row['file_kk'],  $baseUploadUrlKk,  "kk");
                ?>
              </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="box-body">
                    <input type="hidden" name="id" value="<?php echo $row['id_slh']; ?>">
                  </div>
                </div>
