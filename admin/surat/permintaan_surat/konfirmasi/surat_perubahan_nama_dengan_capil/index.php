<?php 
  ...
  // ambil data penduduk + data surat perubahan nama capil
  $qCek = mysqli_query($connect,"
    SELECT penduduk.*, surat_perubahan_nama_capil.*
    FROM penduduk
    LEFT JOIN surat_perubahan_nama_capil 
      ON surat_perubahan_nama_capil.nik = penduduk.nik
    WHERE surat_perubahan_nama_capil.id = '$id'
  ");
  ...
  $baseUploadUrl = "../../../../../uploads/perubahan_nama_capil/";
      ...
      <div class="col-md-12">
        <div class="box box-default">
          <div class="box-header with-border">
            <h2 class="box-title"><i class="fas fa-envelope"></i> Konfirmasi Surat Perubahan Nama Capil</h2>
          </div>
          ...
          <div class="box-body">
            <form class="form-horizontal" method="post" action="update-konfirmasi.php">
              ...
              <h5 class="box-title pull-right" style="color: #696969;">
                <i class="fas fa-info-circle"></i> <b>Informasi Surat Perubahan Nama</b>
              </h5>
              <br><hr style="border-bottom: 1px solid #DCDCDC;">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="box-body">
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Nama Lama</label>
                      <div class="col-sm-9">
                        <input type="text" value="<?php echo $row['nama_lama']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Nama Baru</label>
                      <div class="col-sm-9">
                        <input type="text" value="<?php echo $row['nama_baru']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" value="<?php echo !empty($row['alasan_perubahan']) ? $row['alasan_perubahan'] : '-'; ?>" class="form-control" readonly>
                      </div>
                    </div>
              ...
              <div class="row">
                <?php
                  renderFileCard("Foto Asli Kutipan Akta Capil", $row['file_kutipan_akta'], $baseUploadUrl);
                  renderFileCard("Foto KK Termohon", $row['file_kk_termohon'], $baseUploadUrl);
                  renderFileCard("Dokumen Negara/Ijazah (Rujukan)", $row['file_ijazah_rujukan'], $baseUploadUrl);
                  renderFileCard("SPTJM Kebenaran Data", $row['file_sptjm_kebenaran'], $baseUploadUrl);
                ?>
              </div>

              <!-- TANDA TERIMA -->
              <h5 class="box-title pull-right" style="color: #696969;">
                <i class="fas fa-receipt"></i> <b>Tanda Terima</b>
              </h5>
              <br><hr style="border-bottom: 1px solid #DCDCDC;">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="box-body">
                    <div class="form-group">
                      <label class="col-sm-3 control-label">No. Tanda Terima</label>
                      <div class="col-sm-9">
                        <input type="text" value="<?php echo $row['no_tanda_terima']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                  </div>
                </div>
